...
import { Separator } from '@/old/app/_shared/components/ui/separator';
...
function FieldLegend(
  { className, variant = 'legend', ...props }: React.ComponentProps & { variant?: 'legend' | 'label' },
) {
  return (
    <legend
...
function Field({ className, orientation = 'vertical', ...props }: React.ComponentProps & VariantProps) {
  return (
    <div
      role='group'
      data-slot='field'
